> Historical snapshot of the README before public release (2026-09-20). Private audience, approval and balance statements below are historical, not current deployment status or authorization. See the [current README](../README.md).
